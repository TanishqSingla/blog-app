              ...
              >
                <div data-reactroot="">
                  <div className="following-metadata">
                    <span>
                      <span>
                        <b>{Items.profile.user.followers.length}</b>Follower
                      </span>
                    </span>
                  </div>
                  <div>
            ...
            <div className="post-panel">
              ...
              <div className="main-body">
                ...
                <div className="post-body">
                  <p
                    className=""
                    dangerouslySetInnerHTML={{ __html: article.desciption }}
                  ></p>
                </div>
              ...
              <div className="post-stat clearfix">
...
Profile.protoType = {
  params: propType.object.isReuired,
};
