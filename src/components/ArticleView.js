...
class ArticleView extends React.Component {
  componentDidMount() {
    document.body.className = "post show";
  }
  componentWillMount() {
    ...
    return (
      <div>
        <div className="container-fluid main-container">
              ...
              <div className="post-stats clearfix">
                <div className="pull-left">
                  <div className="like-button-wrapper">
                    <button
                      onClick={() => this.props.clap(this.props._article_id)}
                      className="like-button"
                      data-behaviour="trigger-overlay"
                      type="submit"
                    >
          ...
          <div
            className="post-show-footer row animate fadeInUp"
            data-animation="fadeInUp-fadeOutDown"
          >
            ...
            <div
              id="responses"
              className="col-xs-10 col-md-6 col-xs-offset-1 col-md-offset-3 main-conent"
            >
              <h4 className="small-heading">Responses</h4>
              <div data-beahior="responses-list"></div>
            </div>
          </div>
              ...
              <div className="post-stats flex-container">
                ...
                <div>
                  <a
                    ...
                    href="https://my-medium-clone.herokuapp.com/post/it-s-looking-good#responses"
                  >
                    <i className="fa fa-comment-o"></i>
                    <span
                      className="response-count"
                ...
                <div className="metabar-author-info flex-container flex-space-btw">
                  <div>
                    <img
                      ...
                      width="35"
                    />
                    <div data-react-className="PropoverLink">
                      <span className="propover-link" data-reactroot="">
                        <a href={`/profile/${author_img}`}></a>
                      </span>
                    </div>
                  </div>
